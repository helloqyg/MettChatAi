	...
	<view class="page_container helper">
		<view class="page_content">
			...
			<view class="main_content">
				...
				<view class="reset_box" v-if="options.isChat && relink" @click="initSocketServe(1)">已断开，点击我重新连接…</view>
			</view>
			<view class="footer_content">
				<view class="input_box"v-if="options.isChat">
		...
		methods: {
			...
			initSocketServe(t) {
				...
				this.webSocket = uni.connectSocket({
					url: `${domain}?type=${type}&token=${token}&prompt_id=${prompt_id}`,
					complete: complete => {}
				});
				// 连接打开
